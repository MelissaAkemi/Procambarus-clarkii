...
#Diretório
setwd("C:/Users/melia/Desktop/P. clarkii/RSTUDIO v1/Layers/futuro/miroc585")
...
miroc585<-stack("C:/Users/melia/Desktop/P. clarkii/RSTUDIO v1/Layers/futuro/tif/wc2.1_5m_bioc_MIROC6_ssp585_2021-2040.tif.opdownload")
names(miroc585)
####MIROC6 ssp585####
...
for(i in 1:19){
  ...
  # nome do arquivo pdf
  pdf_name <- sprintf("%s_miroc_sp585.pdf", bio_name)
