...
#Diretório
setwd("C:/Users/melia/Desktop/P. clarkii/RSTUDIO v1/Layers/futuro/bcc126")
...
bcc126<-stack("C:/Users/melia/Desktop/P. clarkii/RSTUDIO v1/Layers/futuro/tif/wc2.1_5m_bioc_BCC-CSM2-MR_ssp126_2021-2040.tif.opdownload")
names(126)
####BCC-CSM2-MR ssp126####
...
for(i in 1:19){
  ...
  # nome do arquivo pdf
  pdf_name <- sprintf("%s_bcc_sp126.pdf", bio_name)
