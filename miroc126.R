...
#Diretório
setwd("C:/Users/melia/Desktop/P. clarkii/RSTUDIO v1/Layers/futuro/miroc126")
...
miroc126<-stack("C:/Users/melia/Desktop/P. clarkii/RSTUDIO v1/Layers/futuro/tif/wc2.1_5m_bioc_MIROC6_ssp126_2021-2040.tif.opdownload")
names(miroc126)
####MIROC6 ssp126####
...
for(i in 1:19){
  ...
  # nome do arquivo pdf
  pdf_name <- sprintf("%s_miroc_sp126.pdf", bio_name)
