...
#Diretório
setwd("C:/Users/melia/Desktop/P. clarkii/RSTUDIO v1/Layers/futuro/ipsl126")
...
ipsl126<-stack("C:/Users/melia/Desktop/P. clarkii/RSTUDIO v1/Layers/futuro/tif/wc2.1_5m_bioc_IPSL-CM6A-LR_ssp126_2021-2040.tif")
names(ipsl126)
####IPSL-CM6A-LR ssp126####
...
for(i in 1:19){
  ...
  # nome do arquivo pdf
  pdf_name <- sprintf("%s_ipsl_sp126.pdf", bio_name)
