...
#Diretório
setwd("C:/Users/melia/Desktop/P. clarkii/RSTUDIO v1/Layers/futuro/ipsl585")
...
ipsl585<-stack("C:/Users/melia/Desktop/P. clarkii/RSTUDIO v1/Layers/futuro/tif/wc2.1_5m_bioc_IPSL-CM6A-LR_ssp585_2021-2040.tif.opdownload")
names(ipsl585)
####IPSL-CM6A-LR ssp585####
...
for(i in 1:19){
  ...
  # nome do arquivo pdf
  pdf_name <- sprintf("%s_ipsl_sp585.pdf", bio_name)
